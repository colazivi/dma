...
# Changed to support yacc in addition to bison
#
# YACC Support is limited! Do NOT use DEFINES_FILE!
#[=======================================================================[.rst:
FindYACC
---------
...
find_program(BISON_EXECUTABLE NAMES bison win-bison win_bison yacc DOC "path to the bison executable")
...
if(BISON_EXECUTABLE)
  ...
  if(NOT ${BISON_version_result} EQUAL 0)
    ...
    elseif("${BISON_version_output}" MATCHES "yacc - ([^\n]+)")
      set(BISON_VERSION "${CMAKE_MATCH_1}")
    endif()
  endif()
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(YACC REQUIRED_VARS  BISON_EXECUTABLE
